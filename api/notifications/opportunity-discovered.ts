...
// POST — Supabase Database Webhook on opportunities INSERT.
// Configure in Supabase Dashboard → Database → Webhooks:
//   Table: opportunities | Events: INSERT
//   URL: https://www.confluenceco.org/api/notifications/opportunity-discovered
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const results = { sent: 0, skipped_opted_out: 0, errors: [] as string[] }
  ...
  const subject = `[Confluence Colorado] New grant opportunity: ${record.name}`
