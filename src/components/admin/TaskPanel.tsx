...
import type { Task, OpportunityTypeId } from '../../lib/adminTypes'
        ...
        <div className="mb-3 p-3 bg-gray-50 rounded-lg border border-gray-200 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="text-xs bg-cc-sage-ink hover:bg-cc-sage-ink/90 disabled:opacity-50 text-white px-3 py-1.5 rounded-lg transition-colors"
            >
