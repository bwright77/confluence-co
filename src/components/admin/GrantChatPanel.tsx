      ...
      <div className="border-t border-gray-100 pt-3">
        ...
        <form onSubmit={handleSend} className="flex gap-2">
          <input
            ...
            aria-label="Message to the AI draft assistant"
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-cc-sage-ink text-white text-sm px-4 py-2 rounded-lg hover:bg-cc-sage-ink/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shrink-0"
          >
