...
export default function BoardMeetingNew() {
  ...
  useEffect(() => {
    document.title = 'New board meeting · Confluence Colorado admin'
  }, [])
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {step === 1 && (
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
            <div>
              <label htmlFor="meeting_date" className="block text-sm font-medium text-navy mb-1.5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="meeting_start" className="block text-sm font-medium text-navy mb-1.5">
              ...
              <div>
                <label htmlFor="meeting_end" className="block text-sm font-medium text-navy mb-1.5">
            ...
            <div>
              <label htmlFor="location" className="block text-sm font-medium text-navy mb-1.5">
        ...
        {step === 2 && (
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
            <div>
              <label htmlFor="transcript_raw" className="block text-sm font-medium text-navy mb-1.5">
